package cn.yesterday17.kokoalinux.exceptions;
...
/**
 * "borrowed" from codes.biscuit.skyblockaddons.exceptions.LoadingException
 * @author sba devs
 */
public class LoadingException extends CustomModLoadingErrorDisplayException {
    ...
    public void drawScreen(GuiErrorScreen errorScreen, FontRenderer fontRenderer, int mouseRelX, int mouseRelY, float tickTime) {
        ...
        errorScreen.drawCenteredString(fontRenderer, String.format(
                        "KokoaLinux%s has encountered an error while loading.%s", WHITE, RESET), xCenter,
                yPos, 0xFF82AB);
        yPos += 20;
        if (getMessage() != null) {
